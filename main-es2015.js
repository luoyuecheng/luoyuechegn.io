...
/* harmony import */ var _form_data_form_data_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./form-data/form-data.component */ "./src/app/form-data/form-data.component.ts");
/* harmony import */ var _archives_archives_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./archives/archives.component */ "./src/app/archives/archives.component.ts");
...
/* harmony import */ var _update_article_update_article_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./update-article/update-article.component */ "./src/app/update-article/update-article.component.ts");
/* harmony import */ var _correction_data_correction_data_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./correction-data/correction-data.component */ "./src/app/correction-data/correction-data.component.ts");
...
const routes = [
    ...
    { path: 'form-data', component: _form_data_form_data_component__WEBPACK_IMPORTED_MODULE_5__["FormDataComponent"] },
    { path: 'archives', component: _archives_archives_component__WEBPACK_IMPORTED_MODULE_6__["ArchivesComponent"] },
    { path: 'archives/:date', component: _archives_archives_component__WEBPACK_IMPORTED_MODULE_6__["ArchivesComponent"] },
    { path: 'category', component: _category_category_component__WEBPACK_IMPORTED_MODULE_7__["CategoryComponent"] },
    { path: 'tag', component: _tag_tag_component__WEBPACK_IMPORTED_MODULE_8__["TagComponent"] },
    // 登录
    { path: 'login', component: _login_login_component__WEBPACK_IMPORTED_MODULE_9__["LoginComponent"] },
    // 更新文章(上传, 更新)
    { path: 'update-article', component: _update_article_update_article_component__WEBPACK_IMPORTED_MODULE_10__["UpdateArticleComponent"] },
    { path: 'update-article/:id', component: _update_article_update_article_component__WEBPACK_IMPORTED_MODULE_10__["UpdateArticleComponent"] },
    // 数据订正
    { path: 'correction-data', component: _correction_data_correction_data_component__WEBPACK_IMPORTED_MODULE_11__["CorrectionDataComponent"] },
...
/* harmony import */ var _form_data_form_data_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./form-data/form-data.component */ "./src/app/form-data/form-data.component.ts");
...
/* harmony import */ var _common_mark_common_mark_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./common-mark/common-mark.component */ "./src/app/common-mark/common-mark.component.ts");
...
/* harmony import */ var _archives_archives_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./archives/archives.component */ "./src/app/archives/archives.component.ts");
/* harmony import */ var _category_category_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./category/category.component */ "./src/app/category/category.component.ts");
...
/* harmony import */ var _update_article_update_article_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./update-article/update-article.component */ "./src/app/update-article/update-article.component.ts");
/* harmony import */ var _correction_data_correction_data_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./correction-data/correction-data.component */ "./src/app/correction-data/correction-data.component.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [], imports: [[
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_4__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_15__["environment"].firebase, 'blog'),
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_9__["AppComponent"],
        ...
        _form_data_form_data_component__WEBPACK_IMPORTED_MODULE_12__["FormDataComponent"],
        _articles_articles_component__WEBPACK_IMPORTED_MODULE_13__["ArticlesComponent"],
        _common_mark_common_mark_component__WEBPACK_IMPORTED_MODULE_14__["CommonmarkComponent"],
        _about_about_component__WEBPACK_IMPORTED_MODULE_16__["AboutComponent"],
        _archives_archives_component__WEBPACK_IMPORTED_MODULE_17__["ArchivesComponent"],
        _category_category_component__WEBPACK_IMPORTED_MODULE_18__["CategoryComponent"],
        _tag_tag_component__WEBPACK_IMPORTED_MODULE_19__["TagComponent"],
        _login_login_component__WEBPACK_IMPORTED_MODULE_20__["LoginComponent"],
        _update_article_update_article_component__WEBPACK_IMPORTED_MODULE_21__["UpdateArticleComponent"],
        _correction_data_correction_data_component__WEBPACK_IMPORTED_MODULE_22__["CorrectionDataComponent"]], imports: [
        // BrowserModule 仅由AppModule或RootModule导入
        _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_7__["AppRoutingModule"],
        _component_page_common_component__WEBPACK_IMPORTED_MODULE_8__["PageCommonModule"],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _login_login_component__WEBPACK_IMPORTED_MODULE_20__["LoginComponent"],
                    _update_article_update_article_component__WEBPACK_IMPORTED_MODULE_21__["UpdateArticleComponent"],
                    _correction_data_correction_data_component__WEBPACK_IMPORTED_MODULE_22__["CorrectionDataComponent"],
                ],
                imports: [
                    // BrowserModule 仅由AppModule或RootModule导入
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
...
ArticlesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ArticlesComponent, selectors: [["app-articles"]], viewQuery: function ArticlesComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 6, vars: 4, consts: [[1, "art-container", "markdown-body"], [3, "data"], [1, "toc-container"], [1, "aio-toc"], [3, "class", "title", 4, "ngFor", "ngForOf"], [3, "title"], [3, "click"]], template: function ArticlesComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        ...
        var tmp_0_0 = null;
        const currVal_0 = (tmp_0_0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](2, 2, ctx.artContent)) == null ? null : tmp_0_0.content;
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
...
class CommonmarkComponent {
    ...
    render(markdown) {
        const compiled = this.commonMarkService.compile(markdown);
...
CommonmarkComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CommonmarkComponent, selectors: [["common-mark"]], inputs: { data: "data", src: "src" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵNgOnChangesFeature"]], ngContentSelectors: _c0, decls: 1, vars: 0, template: function CommonmarkComponent_Template(rf, ctx) { if (rf & 1) {
...
class FormDataComponent {
    constructor(formBuilder, articleService, db) {
    ...
    addArticleToMongo(item, callback) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FormDataComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _services_articles_articles_service__WEBPACK_IMPORTED_MODULE_2__["ArticlesService"] }, { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_3__["AngularFirestore"] }]; }, null); })();
...
class ArticlesService {
    ...
    getArticleList(queryFn) {
        return this.db.collection('article', queryFn).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(actions => actions.map(a => {
    ...
    getArchives(queryFn) {
        return this.db.collection('article', queryFn)
            .snapshotChanges()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(actions => actions.map(a => (Object.assign(Object.assign({}, a.payload.doc.data()), { id: a.payload.doc.id })))));
    }
    /**
     * Get Category list
     */
    ...
    updateArticle(id, article) {
        ...
        return this.db.collection('article').doc(id).set(article, { merge: true });
    }
    ...
    getMdContent(url) {
        return this.http.post('/api/mdContent', { "contentUrl": url, "id": 1 }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(_ => console.log(`fetched article content url=${url}`)));
    }
    addArticleToService(content) {
        return this.http.post('/api/demo/insert', content).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(_ => console.log(`fetched article content=${JSON.stringify(content)}`)));
    }
}
ArticlesService.ɵfac = function ArticlesService_Factory(t) { return new (t || ArticlesService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_3__["AngularFirestore"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_fire_auth__WEBPACK_IMPORTED_MODULE_4__["AngularFireAuth"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ArticlesService, [{
    ...
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }, { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_3__["AngularFirestore"] }, { type: _angular_fire_auth__WEBPACK_IMPORTED_MODULE_4__["AngularFireAuth"] }]; }, null); })();
...
const _c0 = ["formRef"];
function UpdateArticleComponent_span_29_Template(rf, ctx) { if (rf & 1) {
    ...
    ngOnInit() {
        ...
        if (id) {
            this.articlesService.getArticle(id).subscribe(data => {
                ...
                this.validateForm.setValue(initData);
            });
        }
    }
    handleSubmit(values) {
        ...
        const data = Object.assign(Object.assign({}, values), { tags: values.tags.split(',').map(item => item.trim()), createTime: new Date().valueOf(), updateTime: 0 });
        if (this.id) {
            data.id = this.id;
        }
...
UpdateArticleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UpdateArticleComponent, selectors: [["app-update-article"]], viewQuery: function UpdateArticleComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        var _t;
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵqueryRefresh"](_t = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵloadQuery"]()) && (ctx.formRef = _t.first);
    } }, decls: 30, vars: 2, consts: [[1, "app-container"], [3, "formGroup", "ngSubmit"], ["formRef", ""], [1, "form-item-control-wrapper"], ["type", "text", "formControlName", "title", "placeholder", "Title", "spellcheck", "false", 1, "form-control"], [1, "form-item-label"], ["type", "text", "formControlName", "category", "placeholder", "Category", "spellcheck", "false", 1, "form-control"], ["type", "text", "formControlName", "tags", "placeholder", "tags", "spellcheck", "false", 1, "form-control"], ["formControlName", "description", "placeholder", "Description", "rows", "2", "spellcheck", "false", 1, "form-control"], ["formControlName", "content", "placeholder", "Content", "rows", "4", "spellcheck", "false", 1, "form-control"], ["type", "submit", 1, "bottom"], ["class", "explain-error", 4, "ngIf"], [1, "explain-error"]], template: function UpdateArticleComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "section", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "h2");
...
module.exports = __webpack_require__(/*! D:\files\blog\src\main.ts */"./src/main.ts");
